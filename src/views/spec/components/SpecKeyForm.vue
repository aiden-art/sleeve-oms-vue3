<template>
  <div class="spec-form">
    <el-form ref="ELFormRef" size="small" :model="specKeyForm" label-width="80px" :rules="categoryFormRules">
      ...
      <el-form-item label="规格名描述" prop="description">
        <el-input-number v-model="specKeyForm.description"></el-input-number>
      </el-form-item>
